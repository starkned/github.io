...
def gameover():
    ...
    sys.exit()
    '''
    Deadmenu.Deadmenu(pygame.display.set_mode((640, 480)))
...
def main():
    ...
    pygame.mixer.music.load("Kaer_Morhen.mp3")

    # 创建窗口，定义标题
    screen = pygame.display.set_mode((640, 480))
    pygame.display.set_caption("majia的贪吃蛇")
    # 音乐
    ...
    while True:
        ...
        if state == "mainmenu":
            ...
            # 绘制pygame显示层
            screen.fill(C.blackColor)

            for position in snakeSegments:  # 蛇身为白色
                # 化蛇
                pygame.draw.rect(screen, C.pinkColor, Rect(position[0], position[1], 20, 20))
                pygame.draw.rect(screen, C.whiteColor, Rect(foodPostion[0], foodPostion[1], 20, 20))
